                    ...
                    {newCourse?(
                        ...
                        <div className="col-lg-8 col-md-8" >
                            ...
                            <p className="course-detail-prices">
                                ...
                                Share for backers: <label className="course-detail-price">70%</label> <br/>
                                Actual pool: <label className="course-detail-price">0.2 ETH</label>
                            </p>
                            </div>
                            <div className="col-lg-6 col-md-6" >
                              <div className="">
                                ...
                                <input
                                  ...
                                  id="nombre"
                                  style={{width:'100px'}}
                                  onChange={e => setChangeInvestment(e.target.value)}
                                /> 
                                <span className="detail-price-red">ETH  </span>
                              </div>
                            ...
                            <div className="col-lg-12 col-md-12" >
                            <p className="course-stake">With this <label id="label-investment" className="course-stake">{investment}</label> investment, your new share will be <label id="label-value" className="course-stake">{newPercent}%</label> from the backers pool. </p>
                            </div>
                          </div>
                            ...
                            <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
                                ...
                                <div className="course-card-text col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <p className="course-card-prices">
                                        ...
                                        Share for backers: <label className="course-card-price">85%</label> <br/>
                                        Actual pool: <label className="course-card-price">0.3 ETH</label>
                                    </p>
                            ...
                            <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
                                ...
                                <div className="course-card-text col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <p className="course-card-prices">
                                        ...
                                        Share for backers: <label className="course-card-price">80%</label> <br/>
                                        Actual pool: <label className="course-card-price">0.025 ETH</label>
                                    </p>
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
                                ...
                                <div className="course-card-text col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <p className="course-card-prices">
                                        ...
                                        Share for backers: <label className="course-card-price">90%</label> <br/>
                                        Actual pool: <label className="course-card-price">0.25 ETH</label>
                                    </p>
                                </div>
                            </div>      
                             ...
                             <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
                                ...
                                <div className="course-card-text col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <p className="course-card-prices">
                                        ...
                                        Share for backers: <label className="course-card-price">70%</label> <br/>
                                        Actual pool: <label className="course-card-price">0.2 ETH</label>
                                    </p>
                                </div>
                            </div>      
                            </div>
                            ...
                            <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
                                ...
                                <div className="course-card-text col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <p className="course-card-prices">
                                        ...
                                        Share for backers: <label className="course-card-price">95%</label> <br/>
                                        Actual pool: <label className="course-card-price">0.04 ETH</label>
                                    </p>
                                </div>
                            </div>      
                            <div className="course-card col-lg-6 col-md-6 col-sm-6 col-xs-12" onClick={() => {
